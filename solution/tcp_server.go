	...
	for {
		...
		if err != nil {
			if errors.Is(err, io.EOF) {
				...
				logger.Printf("%v[%v][%v]Read failed err %#v\n", now, remote, mac, err)
			}
			break
		}
